...
main = do
    ...
    print (tail listFromOneToFive) -- [2, 3, 4, 5] => 'tail' returns all the elements except for the first one
    print (init listFromOneToFive) -- [1, 2, 3, 4] => 'init' returns all the elements except for the last one
